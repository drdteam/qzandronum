...
enum
{
	...
	, PLANEF_SPRINGPAD		= 512,	// [BC] Floor bounces actors up at the same velocity they landed on it with.	
};
...
public:
	...
	float				SavedGravity;
	double				SavedFloorXOffset;
	double				SavedFloorYOffset;
	double				SavedCeilingXOffset;
	double				SavedCeilingYOffset;
	double				SavedFloorXScale;
	double				SavedFloorYScale;
	double				SavedCeilingXScale;
	double				SavedCeilingYScale;
	DAngle				SavedFloorAngle;
	DAngle				SavedCeilingAngle;
	DAngle				SavedBaseFloorAngle;
	double				SavedBaseFloorYOffset;
	DAngle				SavedBaseCeilingAngle;
	double				SavedBaseCeilingYOffset;
	double				SavedFriction;
	double				SavedMoveFactor;
	short				SavedSpecial;
	short				SavedDamage;
	short				SavedMOD;
