...
public:
	...
	virtual bool TakeInventory (PClassActor *itemclass, int amount, bool fromdecorate = false, bool notakeinfinite = false, bool bNeedClientUpdate = false);
	...
	AInventory *GiveInventoryTypeRespectingReplacements (PClassActor *type);
